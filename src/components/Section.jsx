    ...
    const sections = MainSection.map((val) => {
        return (
            ...
            <div className={`w-full ${val.bgColor}`}>
                ...
                <div className={`flex mx-auto max-w-[1260px] flex-col ${val.disp} font-notoSans py-14 px-6 md:py-20 md:px-10 xl:py-[120px] gap-5 md:gap-0  md:justify-between`}>
                    ...
                    <div className=' md:w-6/12 lg:w-4/12 flex items-center'>
                        ...
                        <div className=" flex flex-col gap-6 md:gap-10">
                            <h1 className='text-xl sm:text-[4vw] md:text-5xl font-bold sm:leading-[4vw] md:leading-tight'>{val.head}</h1>
